    ...
    <div className='bg-[#fcf9f5] h-[90vh]'>
      ...
      <div className='grid grid-cols-2 place-items-center gap-10'>
        <div className='flex flex-col items-center justify-center gap-3 w-64 p-10 shadow-xl bg-white transform transition-all hover:scale-105'>
          ...
          <p className='text-sm text-[#053A6F] cursor-pointer'>View Doctors</p>
        </div>
        <div className='flex flex-col items-center justify-center gap-3 w-64 p-10 shadow-xl bg-white transform transition-all hover:scale-105'>
          ...
          <p className='text-sm text-[#053A6F] cursor-pointer'>View Appointments</p>
        </div>
        <div className='flex flex-col items-center justify-center gap-3 w-64 p-10 shadow-xl bg-white transform transition-all hover:scale-105'>
          ...
          <p className='text-sm text-[#053A6F] cursor-pointer'>Add Doctors</p>
        </div>
        <div className='flex flex-col items-center justify-center gap-3 w-64 p-10 shadow-xl bg-white transform transition-all hover:scale-105'>
          ...
          <p className='text-sm text-[#053A6F] cursor-pointer'>View messages</p>
        </div>
      </div>
    </div>
  )
