...
function About() {
  return (
    <div className="w-full flex flex-wrap items-center justify-center h-screen gap-x-5 gap-y-10">
      ...
      <div className="my-5 w-1/3">
           ...
           <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="bg-blue-200 rounded-full  text-center p-5 transition-all hover:bg-blue-300">
              ...
              <p>Emergency <br /><span className='text-blue-600'>Services</span></p>
            </div>
            <div className="bg-blue-200 rounded-full  text-center p-5 transition-all hover:bg-blue-300">
              <FontAwesomeIcon icon={faMicroscope}/>
              <p>Accurate <br /><span className='text-blue-600'>Testing</span></p>
            </div>
            <div className="bg-blue-200 rounded-full  text-center p-5 transition-all hover:bg-blue-300">
              <FontAwesomeIcon icon={faAmbulance}/>
              <p>Free <br /><span className='text-blue-600'>Ambulance</span></p>
            </div>
           </div>
      </div>
    </div>
