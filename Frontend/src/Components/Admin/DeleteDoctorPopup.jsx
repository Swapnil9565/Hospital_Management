...
const DeleteDoctorPopup = ({setIsOpenDeletePopup,doctorId}) => {
 ...
 const handleDeleteDoctor=async(doctorId)=>{
    try {
        const res=await axios.delete(`https://hospital-management-99yz.onrender.com/api/admin/deleteDoctor/${doctorId}`,{
            headers:{
  ...
  return (
    <div className='w-60 h-32 bg-slate-900 text-white p-5 rounded-md'>
        ...
        <div className="flex justify-between items-center gap-5 px-5">
            <button className='text-blue-400' onClick={()=>handleDeleteDoctor(doctorId)} >Confirm</button>
            <p>|</p>
