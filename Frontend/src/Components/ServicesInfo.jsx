...
function ServicesInfo() {
  return (
    <div className='bg-zinc-200 h-auto pt-5'>
    <div className="text-center py-4 ">
  <h1 className="text-blue-900 font-bold text-2xl md:text-4xl underline">Services</h1>
    ...
    <div className='flex flex-wrap gap-5 justify-center items-center pb-5'>
      {services.map(({ id,icon, sName, sDesc }) => {
        return (
          <div
            key={id}
            className='w-72 h-1/2 md:h-[40vh] text-center bg-white border-2 border-zinc-200 flex flex-col items-center justify-center gap-5 p-3 rounded-md transition-transform  hover:scale-105'>
